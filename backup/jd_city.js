    ...
    if (cookiesArr[i]) {
      ...
      for (let i = 0; i < inviteCodeList.length && true; ++i) {
        ...
        if (inviteCodeList[i].name === $.UserName) {
          ...
          console.log(`\n${$.UserName}去助力${inviteCodeList[i].name},助力码：${inviteCodeList[i].code}\n`);
          let res = await getInfo(inviteCodeList[i].code)
          if (res && res['data'] && res['data']['bizCode'] === 0) {
            ...
            if (res['data']['result']['toasts'] && res['data']['result']['toasts'][0]) {
              console.log(`助力 【${inviteCodeList[i].name}】:${res.data.result.toasts[0].msg}`)
            }
          }
